...
/** Recreates the original fixed Thunderstorm workflow as a stage chain. Kept in sync
	...
	stages: [
		{
			...
			helperModelVendor: 'copilot',
			helperModelFamily: 'gpt-5.6-luna',
			prompt:
				'Du bist ein erfahrener Software-Architekt. Bewerte die folgende Ticket-Beschreibung: Ist sie klar, eindeutig und vollständig genug, um von einem Entwickler direkt implementiert zu werden, ohne dass Rückfragen nötig sind? Dir steht ein delegate_search-Tool zur Verfügung, mit dem du gezielte Rechercheanfragen zum bestehenden Code stellen kannst (z. B. ob eine erwähnte Komponente/Funktion schon existiert, wie sie heißt oder aufgebaut ist) – nutze es bei Unklarheiten, bevor du das Ticket als unvollständig bewertest. Das kann manche Rückfrage an den Nutzer überflüssig machen.\n\nTicket-Beschreibung:\n{{ticket}}\n\n{{additionalInfo}}',
		},
		{
			id: 'implementation',
			type: 'ai',
