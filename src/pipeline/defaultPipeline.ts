...
export const DEFAULT_PIPELINE: PipelineDefinition = {
	stages: [
		...
		},
		{
			...
			prompt:
				'Du bist ein erfahrener Softwareentwickler. Implementiere die folgende Anforderung im aktuellen Workspace mithilfe der verfügbaren Tools – deren eigene Beschreibungen erklären, wofür und wann welches gedacht ist. WICHTIG: Jede Code-Änderung MUSS über write_file oder replace_in_file tatsächlich geschrieben werden – eine Änderung nur in deiner Antwort zu beschreiben oder anzukündigen reicht nicht, sie wird sonst nicht angewendet. Das gilt auch, wenn du nur eine bereits vorgeschlagene Korrektur nachträglich anpasst. Lies eine Datei nur erneut, wenn es dafür einen konkreten Grund gibt – nicht routinemäßig zur Kontrolle. Fasse am Ende in Prosa zusammen, was du (bzw. deine Agenten) tatsächlich geschrieben habt und warum.\n\nTicket-Beschreibung:\n{{ticket}}\n\nBisheriger Kontext:\n{{context}}\n\n{{additionalInfo}}',
		},
		{
			id: 'verification',
			type: 'ai',
